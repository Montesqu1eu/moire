(function () {
  ...
  var e = {
      86: function (e, t, r) {
        ...
        const o = "https://vue-moire.skillbox.cc";
      },
      9489: function (e, t, r) {
        var o = {};
        r.r(o),
          r.d(o, {
            ...
            syncCartProducts: function () {
              return J;
            },
            updateCartProductAmount: function () {
              return $;
            },
            updateCartProductsData: function () {
              return G;
            },
            updateOrderInfo: function () {
              return Y;
            },
            updateUserAccessKey: function () {
              return B;
            },
          });
        var n = {};
        r.r(n),
          r.d(n, {
            ...
            deleteCartProductItem: function () {
              return ce;
            },
            loadCart: function () {
              return oe;
            ...
            updateCartProductAmountAction: function () {
              return ae;
            },
          });
        var a = r(9242),
          c = r(3396);
        const i = { class: "body-wrapper" };
        function s(e, t, r, o, n, a) {
          const s = (0, c.up)("HeaderRegion"),
            u = (0, c.up)("router-view"),
            l = (0, c.up)("FooterRegion");
          return (
            (0, c.wg)(),
            (0, c.iD)("div", i, [(0, c.Wm)(s), (0, c.Wm)(u), (0, c.Wm)(l)])
          );
        }
        var u = r.p + "img/logo-moire.86b9e557.svg";
        const l = { class: "header container" },
          d = { class: "header__wrapper" },
          f = (0, c._)("span", { class: "header__info" }, "Каталог", -1),
          p = (0, c._)(
            "img",
            {
        ...
        function h(e, t, r, o, n, a) {
          const i = (0, c.up)("router-link"),
            s = (0, c.up)("CartIndicator");
          return (
            (0, c.wg)(),
            (0, c.iD)("header", l, [
              (0, c._)("div", d, [
                ...
                (0, c.Wm)(
                  i,
                  { to: { name: "main" }, class: "header__logo" },
                  { default: (0, c.w5)(() => [p]), _: 1 }
                ),
                m,
                (0, c.Wm)(s),
              ]),
        ...
        const _ = (0, c._)(
          ...
          v = { "aria-label": "Количество товаров", class: "header__count" };
              ...
              },
              {
                default: (0, c.w5)(() => [
                  ...
                  (0, c._)(
                    "span",
                    v,
                    (0, g.zw)(e.$store.state.cartProducts.length),
                    1
                  ),
                ]),
                _: 1,
        ...
        var b = { name: "CartIndicator" },
          C = r(89);
        const k = (0, C.Z)(b, [["render", y]]);
        var w = k,
          I = { name: "HeaderRegion", components: { CartIndicator: w } };
        const P = (0, C.Z)(I, [["render", h]]);
        var A = P;
        const K = { class: "footer container" },
          O = { class: "footer__wrapper" },
          D = { class: "footer__links" },
          j = (0, c.Uk)(" Каталог "),
          q = (0, c._)(
            "li",
            null,
            [
              (0, c._)(
                "a",
                { class: "footer__link", href: "tel:88006009009" },
                " 8 800 600 90 09 "
              ),
            ],
            -1
          ...
          x = (0, c._)(
            ...
            [
              (0, c._)(
                "a",
                { class: "footer__link", href: "mailto:hi@moire.com" },
                " hi@moire.com "
              ),
            ],
            -1
          ...
          T = (0, c._)(
            "li",
            null,
            [(0, c._)("span", { class: "footer__link" }, " Распродажа ")],
            -1
          ),
          H = (0, c._)(
            "li",
              ...
              (0, c._)("div", O, [
                (0, c._)("ul", D, [
                  (0, c._)("li", null, [
                    (0, c.Wm)(
                      i,
                      { to: { name: "main" }, class: "footer__link" },
                      { default: (0, c.w5)(() => [j]), _: 1 }
                    ),
                  ]),
                  q,
                  x,
        ...
        var E = { name: "FooterRegion" };
        const F = (0, C.Z)(E, [["render", M]]);
        var S = F,
          V = r(65),
          Z = {
            components: { FooterRegion: S, HeaderRegion: A },
            methods: {
              ...(0, V.nv)(["loadCart"]),
              ...(0, V.OI)(["updateUserAccessKey"]),
            },
            created() {
              const e = localStorage.getItem("userAccessKey");
              e && this.updateUserAccessKey(e), this.loadCart();
            },
          };
        const L = (0, C.Z)(Z, [["render", s]]);
        var N = L,
          R = r(5431);
        (0, R.z)("/moire/service-worker.js", {
          ready() {
            console.log(
        ...
        function $(e, { productId: t, quantity: r }) {
          const o = e.cartProducts.find((e) => e.productId === t);
          o && (o.quantity = r);
        }
        function G(e, t) {
        ...
        function J(e) {
          e.cartProducts = e.cartProductsData.map((e) => ({
            productId: e.product.id,
            quantity: e.quantity,
            colorId: e.color.color.id,
            sizeId: e.size.id,
            basketItemId: e.id,
          }));
        }
        function Q(e, t) {
          e.cartProducts = e.cartProducts.filter((e) => e.productId !== t);
        }
        function X(e) {
          (e.cartProducts = []), (e.cartProductsData = []);
        }
        function Y(e, t) {
          e.orderInfo = t;
        }
          ...
          await te()
            ...
            .then((t) => {
              e.state.userAccessKey ||
                ...
                e.commit("updateCartProductsData", t.data.items),
                e.commit("syncCartProducts");
            });
        }
        async function ne(
          e,
          { productId: t, colorId: r, sizeId: o, quantity: n }
        ) {
          return await te()
            .post(
              re.C + "/api/baskets/products",
              { productId: t, colorId: r, sizeId: o, quantity: n },
              { params: { userAccessKey: e.state.userAccessKey } }
            )
            .then((t) => {
        ...
        async function ae(e, { basketItemId: t, quantity: r }) {
          if (
            (e.commit("updateCartProductAmount", {
              basketItemId: t,
              quantity: r,
            }),
            !(r < 1))
        ...
        async function ce(e, t) {
          (e.state.cartProducts = e.state.cartProducts.filter(
            (e) => e.basketItemId !== t
          )),
            await te()
              ["delete"](re.C + "/api/baskets/products", {
                params: { userAccessKey: e.state.userAccessKey },
                data: { basketItemId: t },
              })
              .catch((t) => {
        ...
        function ie(e, t) {
          return new Promise((r, o) => {
            te()
              .get(re.C + "/api/orders/" + t, {
                params: { userAccessKey: e.state.userAccessKey },
              })
              .then((t) => {
                r(t), e.commit("updateOrderInfo", t.data);
              })
              .catch((e) => o(e));
          });
        }
        var se = (0, V.MT)({
          ...
          modules: {},
          getters: {
            cartDetailProducts(e) {
              return e.cartProducts.map((t) => {
                const r = e.cartProductsData.find(
                    (e) => e.product.id === t.productId
                  ).product,
                  o = e.cartProductsData.find((e) => e.size.id === t.sizeId);
                return {
                  ...t,
                  size: o.size,
                  product: {
                    ...r,
                    colors: r.colors.find((e) => e.color.id === t.colorId),
                    gallery: r.colors.find((e) => e.color.id === t.colorId)
                      .gallery[0].file.url,
                  },
                };
              });
            ...
            cartTotalPrice(e, t) {
              return t.cartDetailProducts.reduce(
                (e, t) => t.product.price * t.quantity + e,
                0
              );
            },
          },
        ...
        const ue = [
            {
              path: "/",
              name: "main",
              component: () => r.e(443).then(r.bind(r, 4357)),
            },
            {
              path: "/cart",
              name: "cart",
              component: () => r.e(443).then(r.bind(r, 9903)),
            },
            {
              path: "/order",
              name: "order",
              component: () => r.e(443).then(r.bind(r, 96)),
            },
            {
              path: "/order/:id",
              name: "orderInfo",
              component: () => r.e(443).then(r.bind(r, 9845)),
            },
            {
              path: "/product/:id",
              name: "product",
              component: () => r.e(443).then(r.bind(r, 3310)),
            },
            {
              path: "/error",
              name: "error",
              component: () => r.e(443).then(r.bind(r, 5113)),
            },
            { path: "/:pathMatch(.*)*", redirect: "error" },
          ],
          le = (0, W.p7)({ history: (0, W.r5)("/moire/"), routes: ue });
        le.beforeEach((e, t, r) => {
          "error" === e.name ||
          "orderInfo" !== e.name ||
          (se.state.orderInfo && se.state.orderInfo.id === e.params.id)
            ? r()
            : se
                .dispatch("loadOrderInfo", e.params.id)
                .then(() => r())
                .catch(() => {
                  r({ name: "error" });
                });
        ...
        var de = le,
          fe = r(3910);
        (0, a.ri)(N).use(se).use(de).use(fe.Z).mount("#app");
      },
    },
    t = {};
  function r(o) {
  ...
  (r.m = e),
    ...
    (function () {
      (r.f = {}),
        (r.e = function (e) {
          return Promise.all(
            Object.keys(r.f).reduce(function (t, o) {
              return r.f[o](e, t), t;
            }, [])
          );
        });
    ...
    (function () {
      ...
      var t = function (t, o) {
          ...
          for (t && t(o); u < c.length; u++)
            (a = c[u]), r.o(e, a) && e[a] && e[a][0](), (e[a] = 0);
          return r.O(l);
        },
        o = (self["webpackChunkdiploma"] = self["webpackChunkdiploma"] || []);
